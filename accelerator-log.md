...
{
  "gitBranch" : "main",
  "gitUrl" : "https://github.com/tsalm-pivotal/tap-demos-w01-s001.git",
...
┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [https://github.com/tanzu-end-to-end/spring-sensors.git->https://github.com/t...(truncated), main->main]
